...
# Temporary solution
#ARG1='./workflow.json'
#ARG2='4 CMCC-CM rcp85 day 0.9 1980_2010 2080_2100 20:60|0:60 /data/repository /home/sysm01/INDIGO'

curl "https://raw.githubusercontent.com/FutureGateway/ENES-portlet/master/src/utils/ophidia_helper.py" -o ophidia_helper.py
curl "https://raw.githubusercontent.com/FutureGateway/ENES-portlet/master/src/utils/precip_trend_analysis.json" -o precip_trend_analysis.json

#ln -s sayhello.txt oph-credentials.txt
